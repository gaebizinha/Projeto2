...
server.post('/userinsert', urlencodedParser, (req, res) => {
	...
	sql = "INSERT INTO acolhido (nm_nome, apelido, dt_nascimento, nr_cpf, nr_rg, in_locais, ds_locais, ds_albergue, ds_domiciliopart, qt_rua, qt_albergue, qt_domicilio, qt_morarua, st_familia, ds_comunitarias, ds_atendido, st_carteiratrab, ds_renda, ds_progrenda, ds_programarenda) VALUES ('"+ req.body.nm_nome +"', '"+ req.body.apelido +"','" + req.body.data +"', '" + req.body.nr_cpf +"','"+req.body.nr_rg+"','"+ req.body.in_locais +"', '"+ req.body.ds_locais + "', '"+ req.body.albuergue+"', '"+ req.body.ds_domiciliop +"', '"+req.body.qt_r+"','"+req.body.qt_albuergue+"','"+req.body.qt_dom+"','"+req.body.qt_rua+"', '"+req.body.st_f+"', '"+req.body.ds_com+"', '"+req.body.ds_at+"','"+req.body.st_cattrab+"', '"+req.body.ds_renda+"','"+req.body.ds_progren+"','"+req.body.programar+"')";
	var db = new sqlite3.Database(DBPATH); // Abre o banco
	db.run(sql, [],  err => {
		if (err) {
		    throw err;
